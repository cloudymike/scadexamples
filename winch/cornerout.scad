...
rotate([0,0,0]) CornerDent(plate_length,plate_width,corner_radius,plate_thickness);
//translate([0,0,plate_thickness])rotate([0,0,0])mount_holes();
}



module CornerDent(length,width,corner_radius, plate_thickness)
{
translate([0,0,(corner_radius)-plate_thickness/2+low_thickness])
rotate([0,90,0])
{
//difference () {
